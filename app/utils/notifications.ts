...
export const NOTIFICATION_SOUNDS: SoundOption[] = [
  ...
  { id: "yaver-erkek", label: "Yaver (Erkek)", icon: "🎤", description: "Erkek sesli bildirim", isVoice: true },
  { id: "yaver-kiz", label: "Yaver (Kız)", icon: "🎤", description: "Kız sesli bildirim", isVoice: true },
  { id: "ozan-erkek", label: "Ozan (Erkek)", icon: "🎤", description: "Erkek sesli bildirim", isVoice: true },
  { id: "ozan-kiz", label: "Ozan (Kız)", icon: "🎤", description: "Kız sesli bildirim", isVoice: true },
];

// Voice message paths - free sounds from soundbible.com
const VOICE_MESSAGES: Record<string, { erkek: string; kiz: string }> = {
  ...
  taskReminder: {
    erkek: "/sounds/task-reminder.mp3",
    kiz: "/sounds/task-reminder.mp3"
  }
};
